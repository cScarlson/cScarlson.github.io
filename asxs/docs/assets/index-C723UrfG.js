...
`+r.join(`
`),y=this.blockquote(m);o[o.length-1]=y,s=s.substring(0,s.length-b.raw.length)+y.raw,n=n.substring(0,n.length-b.text.length)+y.text;break}else if(d?.type==="list"){let b=d,m=b.raw+`
`+r.join(`
`),y=this.list(m);o[o.length-1]=y,s=s.substring(0,s.length-d.raw.length)+y.raw,n=n.substring(0,n.length-b.raw.length)+y.raw,r=m.substring(o.at(-1).raw.length).split(`
...
`,t=t.substring(d.length+1),i=!0),!i){let y=this.rules.other.nextBulletRegex(m),P=this.rules.other.hrRegex(m),R=this.rules.other.fencesBeginRegex(m),$e=this.rules.other.headingBeginRegex(m),jt=this.rules.other.htmlBeginRegex(m),Ft=this.rules.other.blockquoteBeginRegex(m);for(;t;){let V=t.split(`
`,1)[0],q;if(d=V,this.options.pedantic?(d=d.replace(this.rules.other.listReplaceNesting,"  "),q=d):q=d.replace(this.rules.other.tabCharGlobal,"    "),R.test(d)||$e.test(d)||jt.test(d)||Ft.test(d)||y.test(d)||P.test(d))break;if(q.search(this.rules.other.nonSpaceChar)>=m||!d.trim())c+=`
...
`)},vn="as-css-import";let Re=class extends HTMLStyleElement{constructor(){super();const{attributes:t}=this,{target:e}=t,{value:r}=e,{[r]:s}=fn;this.innerHTML=s}};Re=bn([k(vn,{extends:"style"})],Re);const kn=`\r
as-stateful {\r
    /* border: solid 1px tomato; */\r
    position: relative;\r
    display: inline-block;\r
...
`;var Gn=Object.defineProperty,Wn=Object.getOwnPropertyDescriptor,kt=t=>{throw TypeError(t)},Zn=(t,e,r)=>e in t?Gn(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,Un=(t,e,r,s)=>{for(var n=s>1?void 0:s?Wn(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n},Kn=(t,e,r)=>Zn(t,e+"",r),Yn=(t,e,r)=>e.has(t)||kt("Cannot "+r),Vn=(t,e,r)=>(Yn(t,e,"read from private field"),r?r.call(t):e.get(t)),Jn=(t,e,r)=>e.has(t)?kt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),pe;const es="at-route";let W=class extends we{constructor(){super(),Jn(this,pe,this.innerHTML),Kn(this,"initial","#/")}createRenderRoot(){return this}render(){return`
            <style>
                ${this.tagName} {
                    display: none;
            ...
            ${Vn(this,pe)}
        `}};pe=new WeakMap;W=Un([k(es)],W);const ts="/assets/hero.red-C1_5eBWM.html",rs="/assets/button.red-BEoK94kK.html",ns="/assets/frameless.red-CHxByArx.html",ss="/assets/xs.red-Ctwnx5wo.html",os="/assets/extensible.red-Czq0Umn1.html",as="/assets/excess.red-BtxTB1gd.html",is="/assets/accessible.red-BYSBQAjx.html",ls="/assets/css.red-CtK-onvh.html",cs="/assets/js.red-CD7ALLNg.html",ps="/assets/ts.red-B8udLaFi.html",ds="/assets/footer.rcd-DR3b-oXk.html",us=`\r
...
`;var gs=Object.getOwnPropertyDescriptor,ms=(t,e,r,s)=>{for(var n=s>1?void 0:s?gs(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n};const{log:bs}=console,yt="at-home";let Le=class extends W{get"as:state"(){return{hero:ts,hook:rs,frameless:ns,xs:ss,extensible:os,excess:as,accessibility:is,css:ls,js:cs,ts:ps,footer:ds}}connectedCallback(t=super.connectedCallback()){bs(`@${yt}`)}render(){return`
            ${super.render()}
            <style>${hs}</style>
            ${us}
...
`,de=Object.freeze(Object.defineProperty({__proto__:null,docs:xt,example:vs,setup:fs},Symbol.toStringTag,{value:"Module"})),wt=`\r
## Icons\r
