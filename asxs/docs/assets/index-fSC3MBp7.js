(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();const X="as:state";function he(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var A=he();function Qe(t){A=t}var E={exec:()=>null};function h(t,e=""){let r=typeof t=="string"?t:t.source,s={replace:(n,o)=>{let a=typeof o=="string"?o:o.source;return a=a.replace(b.caret,"$1"),r=r.replace(n,a),s},getRegex:()=>new RegExp(r,e)};return s}var Qt=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),b={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}>`)},Gt=/^(?:[ \t]*(?:\n|$))+/,Wt=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Ut=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,I=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Zt=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,ge=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Ge=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,We=h(Ge).replace(/bull/g,ge).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Kt=h(Ge).replace(/bull/g,ge).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),me=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Yt=/^[^\n]+/,fe=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Vt=h(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",fe).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Jt=h(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,ge).getRegex(),Z="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",be=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,er=h("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",be).replace("tag",Z).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ue=h(me).replace("hr",I).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Z).getRegex(),tr=h(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Ue).getRegex(),ve={blockquote:tr,code:Wt,def:Vt,fences:Ut,heading:Zt,hr:I,html:er,lheading:We,list:Jt,newline:Gt,paragraph:Ue,table:E,text:Yt},_e=h("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",I).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Z).getRegex(),rr={...ve,lheading:Kt,table:_e,paragraph:h(me).replace("hr",I).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",_e).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Z).getRegex()},nr={...ve,html:h(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",be).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:E,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:h(me).replace("hr",I).replace("heading",` *#{1,6} *[^
]`).replace("lheading",We).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},sr=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,or=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Ze=/^( {2,}|\\)\n(?!\s*$)/,ar=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,K=/[\p{P}\p{S}]/u,ke=/[\s\p{P}\p{S}]/u,Ke=/[^\s\p{P}\p{S}]/u,ir=h(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,ke).getRegex(),Ye=/(?!~)[\p{P}\p{S}]/u,lr=/(?!~)[\s\p{P}\p{S}]/u,cr=/(?:[^\s\p{P}\p{S}]|~)/u,Ve=/(?![*_])[\p{P}\p{S}]/u,pr=/(?![*_])[\s\p{P}\p{S}]/u,dr=/(?:[^\s\p{P}\p{S}]|[*_])/u,ur=h(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Qt?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Je=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,hr=h(Je,"u").replace(/punct/g,K).getRegex(),gr=h(Je,"u").replace(/punct/g,Ye).getRegex(),et="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",mr=h(et,"gu").replace(/notPunctSpace/g,Ke).replace(/punctSpace/g,ke).replace(/punct/g,K).getRegex(),fr=h(et,"gu").replace(/notPunctSpace/g,cr).replace(/punctSpace/g,lr).replace(/punct/g,Ye).getRegex(),br=h("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Ke).replace(/punctSpace/g,ke).replace(/punct/g,K).getRegex(),vr=h(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,Ve).getRegex(),kr="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",yr=h(kr,"gu").replace(/notPunctSpace/g,dr).replace(/punctSpace/g,pr).replace(/punct/g,Ve).getRegex(),xr=h(/\\(punct)/,"gu").replace(/punct/g,K).getRegex(),wr=h(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),$r=h(be).replace("(?:-->|$)","-->").getRegex(),_r=h("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",$r).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),j=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,zr=h(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",j).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),tt=h(/^!?\[(label)\]\[(ref)\]/).replace("label",j).replace("ref",fe).getRegex(),rt=h(/^!?\[(ref)\](?:\[\])?/).replace("ref",fe).getRegex(),Tr=h("reflink|nolink(?!\\()","g").replace("reflink",tt).replace("nolink",rt).getRegex(),ze=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,ye={_backpedal:E,anyPunctuation:xr,autolink:wr,blockSkip:ur,br:Ze,code:or,del:E,delLDelim:E,delRDelim:E,emStrongLDelim:hr,emStrongRDelimAst:mr,emStrongRDelimUnd:br,escape:sr,link:zr,nolink:rt,punctuation:ir,reflink:tt,reflinkSearch:Tr,tag:_r,text:ar,url:E},Sr={...ye,link:h(/^!?\[(label)\]\((.*?)\)/).replace("label",j).getRegex(),reflink:h(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",j).getRegex()},re={...ye,emStrongRDelimAst:fr,emStrongLDelim:gr,delLDelim:vr,delRDelim:yr,url:h(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",ze).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:h(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",ze).getRegex()},Er={...re,br:h(Ze).replace("{2,}","*").getRegex(),text:h(re.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},N={normal:ve,gfm:rr,pedantic:nr},M={normal:ye,gfm:re,breaks:Er,pedantic:Sr},Cr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Te=t=>Cr[t];function _(t,e){if(e){if(b.escapeTest.test(t))return t.replace(b.escapeReplace,Te)}else if(b.escapeTestNoEncode.test(t))return t.replace(b.escapeReplaceNoEncode,Te);return t}function Se(t){try{t=encodeURI(t).replace(b.percentDecode,"%")}catch{return null}return t}function Ee(t,e){let r=t.replace(b.findPipe,(o,a,l)=>{let i=!1,p=a;for(;--p>=0&&l[p]==="\\";)i=!i;return i?"|":" |"}),s=r.split(b.splitPipe),n=0;if(s[0].trim()||s.shift(),s.length>0&&!s.at(-1)?.trim()&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;n<s.length;n++)s[n]=s[n].trim().replace(b.slashPipe,"|");return s}function L(t,e,r){let s=t.length;if(s===0)return"";let n=0;for(;n<s&&t.charAt(s-n-1)===e;)n++;return t.slice(0,s-n)}function Ar(t,e){if(t.indexOf(e[1])===-1)return-1;let r=0;for(let s=0;s<t.length;s++)if(t[s]==="\\")s++;else if(t[s]===e[0])r++;else if(t[s]===e[1]&&(r--,r<0))return s;return r>0?-2:-1}function Rr(t,e=0){let r=e,s="";for(let n of t)if(n==="	"){let o=4-r%4;s+=" ".repeat(o),r+=o}else s+=n,r++;return s}function Ce(t,e,r,s,n){let o=e.href,a=e.title||null,l=t[1].replace(n.other.outputLinkReplace,"$1");s.state.inLink=!0;let i={type:t[0].charAt(0)==="!"?"image":"link",raw:r,href:o,title:a,text:l,tokens:s.inlineTokens(l)};return s.state.inLink=!1,i}function Pr(t,e,r){let s=t.match(r.other.indentCodeCompensation);if(s===null)return e;let n=s[1];return e.split(`
...
`)}}}fences(t){let e=this.rules.block.fences.exec(t);if(e){let r=e[0],s=Pr(r,e[3]||"",this.rules);return{type:"code",raw:r,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:s}}}heading(t){let e=this.rules.block.heading.exec(t);if(e){let r=e[2].trim();if(this.rules.other.endingHash.test(r)){let s=L(r,"#");(this.options.pedantic||!s||this.rules.other.endingSpaceChar.test(s))&&(r=s.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:r,tokens:this.lexer.inline(r)}}}hr(t){let e=this.rules.block.hr.exec(t);if(e)return{type:"hr",raw:L(e[0],`
...
${p}`:p,n=n?`${n}
${c}`:c;let u=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(c,o,!0),this.lexer.state.top=u,r.length===0)break;let d=o.at(-1);if(d?.type==="code")break;if(d?.type==="blockquote"){let f=d,m=f.raw+`
`+r.join(`
`),y=this.blockquote(m);o[o.length-1]=y,s=s.substring(0,s.length-f.raw.length)+y.raw,n=n.substring(0,n.length-f.text.length)+y.text;break}else if(d?.type==="list"){let f=d,m=f.raw+`
`+r.join(`
`),y=this.list(m);o[o.length-1]=y,s=s.substring(0,s.length-d.raw.length)+y.raw,n=n.substring(0,n.length-f.raw.length)+y.raw,r=m.substring(o.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:s,tokens:o,text:n}}}list(t){let e=this.rules.block.list.exec(t);if(e){let r=e[1].trim(),s=r.length>1,n={type:"list",raw:"",ordered:s,start:s?+r.slice(0,-1):"",loose:!1,items:[]};r=s?`\\d{1,9}\\${r.slice(-1)}`:`\\${r}`,this.options.pedantic&&(r=s?r:"[*+-]");let o=this.rules.other.listItemRegex(r),a=!1;for(;t;){let i=!1,p="",c="";if(!(e=o.exec(t))||this.rules.block.hr.test(t))break;p=e[0],t=t.substring(p.length);let u=Rr(e[2].split(`
`,1)[0],e[1].length),d=t.split(`
`,1)[0],f=!u.trim(),m=0;if(this.options.pedantic?(m=2,c=u.trimStart()):f?m=e[1].length+1:(m=u.search(this.rules.other.nonSpaceChar),m=m>4?1:m,c=u.slice(m),m+=e[1].length),f&&this.rules.other.blankLine.test(d)&&(p+=d+`
`,t=t.substring(d.length+1),i=!0),!i){let y=this.rules.other.nextBulletRegex(m),R=this.rules.other.hrRegex(m),P=this.rules.other.fencesBeginRegex(m),$e=this.rules.other.headingBeginRegex(m),jt=this.rules.other.htmlBeginRegex(m),Ft=this.rules.other.blockquoteBeginRegex(m);for(;t;){let V=t.split(`
`,1)[0],q;if(d=V,this.options.pedantic?(d=d.replace(this.rules.other.listReplaceNesting,"  "),q=d):q=d.replace(this.rules.other.tabCharGlobal,"    "),P.test(d)||$e.test(d)||jt.test(d)||Ft.test(d)||y.test(d)||R.test(d))break;if(q.search(this.rules.other.nonSpaceChar)>=m||!d.trim())c+=`
`+q.slice(m);else{if(f||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||P.test(u)||$e.test(u)||R.test(u))break;c+=`
`+d}f=!d.trim(),p+=V+`
...
`)?"":`
`)+n.raw,a.text+=`
`+n.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=a.text):r.push(n);continue}if(e){let a="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(a);break}else throw new Error(a)}}return this.state.top=!0,r}inline(e,r=[]){return this.inlineQueue.push({src:e,tokens:r}),r}inlineTokens(e,r=[]){let s=e,n=null;if(this.tokens.links){let i=Object.keys(this.tokens.links);if(i.length>0)for(;(n=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)i.includes(n[0].slice(n[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,n.index)+"["+"a".repeat(n[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(n=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,n.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let o;for(;(n=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)o=n[2]?n[2].length:0,s=s.slice(0,n.index+o)+"["+"a".repeat(n[0].length-o-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=this.options.hooks?.emStrongMask?.call({lexer:this},s)??s;let a=!1,l="";for(;e;){a||(l=""),a=!1;let i;if(this.options.extensions?.inline?.some(c=>(i=c.call({lexer:this},e,r))?(e=e.substring(i.raw.length),r.push(i),!0):!1))continue;if(i=this.tokenizer.escape(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.tag(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.link(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(i.raw.length);let c=r.at(-1);i.type==="text"&&c?.type==="text"?(c.raw+=i.raw,c.text+=i.text):r.push(i);continue}if(i=this.tokenizer.emStrong(e,s,l)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.codespan(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.br(e)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.del(e,s,l)){e=e.substring(i.raw.length),r.push(i);continue}if(i=this.tokenizer.autolink(e)){e=e.substring(i.raw.length),r.push(i);continue}if(!this.state.inLink&&(i=this.tokenizer.url(e))){e=e.substring(i.raw.length),r.push(i);continue}let p=e;if(this.options.extensions?.startInline){let c=1/0,u=e.slice(1),d;this.options.extensions.startInline.forEach(f=>{d=f.call({lexer:this},u),typeof d=="number"&&d>=0&&(c=Math.min(c,d))}),c<1/0&&c>=0&&(p=e.substring(0,c+1))}if(i=this.tokenizer.inlineText(p)){e=e.substring(i.raw.length),i.raw.slice(-1)!=="_"&&(l=i.raw.slice(-1)),a=!0;let c=r.at(-1);c?.type==="text"?(c.raw+=i.raw,c.text+=i.text):r.push(i);continue}if(e){let c="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw new Error(c)}}return r}},Q=class{options;parser;constructor(t){this.options=t||A}space(t){return""}code({text:t,lang:e,escaped:r}){let s=(e||"").match(b.notSpaceStart)?.[0],n=t.replace(b.endingNewline,"")+`
...
`;var mn=Object.getOwnPropertyDescriptor,fn=(t,e,r,s)=>{for(var n=s>1?void 0:s?mn(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n};const bn={"bootstrap-icons":ln,icons:an,buttons:cn,tooltip:pn,popover:dn,dialogs:[un,hn,gn].join(`
`)},vn="as-css-import";let Pe=class extends HTMLStyleElement{constructor(){super();const{attributes:t}=this,{target:e}=t,{value:r}=e,{[r]:s}=bn;this.innerHTML=s}};Pe=fn([k(vn,{extends:"style"})],Pe);const kn=`\r
as-stateful {\r
    /* border: solid 1px tomato; */\r
    position: relative;\r
    display: inline-block;\r
...
`;var yn=Object.getOwnPropertyDescriptor,xn=(t,e,r,s)=>{for(var n=s>1?void 0:s?yn(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n};const wn="as-stateful";let De=class extends HTMLElement{constructor(){super();const{innerHTML:t}=this,r=`${`<style>${kn}</style>`}
${t}`;this.innerHTML=r}};De=xn([k(wn)],De);class $n{constructor(e=[]){this.data=e}get size(){return this.data.length}get empty(){return this.isEmpty()}get front(){return this.getFront()}enqueue(e){const{data:r}=this;return r.push(e),this}dequeue(){const{data:e}=this;return e.shift()}getFront(){return this.data[0]}search(e){const{data:r}=this;return r.indexOf(e)}has(e){return!!~this.search(e)}isEmpty(){return!this.size}clear(){return this.data.length=0,this}}var _n=Object.defineProperty,zn=Object.getOwnPropertyDescriptor,Tn=Object.getPrototypeOf,Sn=Reflect.get,dt=t=>{throw TypeError(t)},En=(t,e,r)=>e in t?_n(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,Cn=(t,e,r,s)=>{for(var n=s>1?void 0:s?zn(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n},An=(t,e,r)=>En(t,e+"",r),Rn=(t,e,r)=>e.has(t)||dt("Cannot "+r),Pn=(t,e,r)=>e.has(t)?dt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),S=(t,e,r)=>(Rn(t,e,"access private method"),r),Dn=(t,e,r)=>Sn(Tn(t),r,e),z,Y,ut,ht,gt,mt,ft;const qe={type:""},qn="as-dialog-queue";let ce=class extends HTMLDialogElement{constructor(){super(...arguments),Pn(this,z),An(this,"queue",new $n)}showModal(t=qe){const{queue:e}=this;t!==qe&&e.enqueue(t),S(this,z,Y).call(this)}handleEvent(t){if(t.type==="as:dialog:close")return S(this,z,ht).call(this,t);if(t.type==="cancel")return S(this,z,gt).call(this,t);if(t.type==="close")return S(this,z,mt).call(this,t);if(t.type==="as:dialog:request")return S(this,z,ft).call(this,t)}connectedCallback(){this.addEventListener("as:dialog:close",this,!0),this.addEventListener("cancel",this,!0),this.addEventListener("close",this,!0),this.addEventListener("as:dialog:request",this,!0)}disconnectedCallback(){this.removeEventListener("as:dialog:close",this,!0),this.removeEventListener("cancel",this,!0),this.removeEventListener("close",this,!0),this.removeEventListener("as:dialog:request",this,!0)}};z=new WeakSet;Y=function(){const{queue:t}=this,{front:e}=t,{type:r,content:s}=e;r==="string"?this.innerHTML=s:S(this,z,ut).call(this,...s),Dn(ce.prototype,this,"showModal").call(this)};ut=function(...t){this.innerHTML="",this.append(...t)};ht=function(t){const{queue:e}=this;e.dequeue(),e.size?S(this,z,Y).call(this):this.close()};gt=function(t){const{queue:e}=this;e.dequeue(),e.size&&(t.preventDefault(),S(this,z,Y).call(this))};mt=function(t){this.queue.clear()};ft=function(t){const{data:e}=t;this.showModal(e)};ce=Cn([k(qn,{extends:"dialog"})],ce);var Mn=Object.defineProperty,Ln=Object.getOwnPropertyDescriptor,bt=t=>{throw TypeError(t)},On=(t,e,r)=>e in t?Mn(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,Bn=(t,e,r,s)=>{for(var n=s>1?void 0:s?Ln(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n},In=(t,e,r)=>On(t,e+"",r),vt=(t,e,r)=>e.has(t)||bt("Cannot "+r),Nn=(t,e,r)=>(vt(t,e,"read from private field"),r?r.call(t):e.get(t)),Hn=(t,e,r)=>e.has(t)?bt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),Xn=(t,e,r,s)=>(vt(t,e,"write to private field"),e.set(t,r),r),H;const jn="as-dialog-antitamper";let Me=class extends HTMLDialogElement{constructor(){super(...arguments),Hn(this,H),In(this,"accepted",!1)}accept(){this.accepted=!0}connectedCallback(){const{parentElement:t}=this;Xn(this,H,t)}disconnectedCallback(){this.accepted||Nn(this,H).appendChild(this)}};H=new WeakMap;Me=Bn([k(jn,{extends:"dialog"})],Me);const Fn=`\r
<div class="asxs app">\r
    ...
    <footer class="app footer">\r
        <iframe src="./v0.0.1/copy.partial.html"></iframe>\r
    </footer>\r
</div>\r
...
`;var Gn=Object.defineProperty,Wn=Object.getOwnPropertyDescriptor,kt=t=>{throw TypeError(t)},Un=(t,e,r)=>e in t?Gn(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,Zn=(t,e,r,s)=>{for(var n=s>1?void 0:s?Wn(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n},Kn=(t,e,r)=>Un(t,e+"",r),Yn=(t,e,r)=>e.has(t)||kt("Cannot "+r),Vn=(t,e,r)=>(Yn(t,e,"read from private field"),r?r.call(t):e.get(t)),Jn=(t,e,r)=>e.has(t)?kt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),pe;const es="at-route";let W=class extends we{constructor(){super(),Jn(this,pe,this.innerHTML),Kn(this,"initial","#/")}createRenderRoot(){return this}render(){return`
            <style>
                ${this.tagName} {
                    display: none;
            ...
            ${Vn(this,pe)}
        `}};pe=new WeakMap;W=Zn([k(es)],W);const ts=""+new URL("hero.red-C1_5eBWM.html",import.meta.url).href,rs=""+new URL("button.red-BEoK94kK.html",import.meta.url).href,ns=""+new URL("frameless.red-CHxByArx.html",import.meta.url).href,ss=""+new URL("xs.red-Ctwnx5wo.html",import.meta.url).href,os=""+new URL("extensible.red-Czq0Umn1.html",import.meta.url).href,as=""+new URL("excess.red-BtxTB1gd.html",import.meta.url).href,is=""+new URL("accessible.red-BYSBQAjx.html",import.meta.url).href,ls=""+new URL("css.red-CtK-onvh.html",import.meta.url).href,cs=""+new URL("js.red-CD7ALLNg.html",import.meta.url).href,ps=""+new URL("ts.red-B8udLaFi.html",import.meta.url).href,ds=""+new URL("footer.rcd-DR3b-oXk.html",import.meta.url).href,us=`\r
...
`;var gs=Object.getOwnPropertyDescriptor,ms=(t,e,r,s)=>{for(var n=s>1?void 0:s?gs(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n};const{log:fs}=console,yt="at-home";let Le=class extends W{get"as:state"(){return{hero:ts,hook:rs,frameless:ns,xs:ss,extensible:os,excess:as,accessibility:is,css:ls,js:cs,ts:ps,footer:ds}}connectedCallback(t=super.connectedCallback()){fs(`@${yt}`)}render(){return`
            ${super.render()}
            <style>${hs}</style>
            ${us}
        `}};Le=ms([k(yt)],Le);class T extends Object{constructor(e){super(e),Object.assign(this,e)}escape(e){return $.escapeHTML(e)}}const xt=`\r
## Variables\r
...
`,de=Object.freeze(Object.defineProperty({__proto__:null,docs:xt,example:vs,setup:bs},Symbol.toStringTag,{value:"Module"})),wt=`\r
## Icons\r
...
`,qs=Object.freeze(Object.defineProperty({__proto__:null,checkbox:As,docs:Cs,files:Ps,radio:Rs,reflections:Ds},Symbol.toStringTag,{value:"Module"})),Ms=Object.freeze(Object.defineProperty({__proto__:null,basic:zs,block:Ts,docs:$t,setup:_s,sizes:Ss,stateful:qs,types:Es},Symbol.toStringTag,{value:"Module"})),_t=`\r
## Tooltips\r
...
`;function Zs(){const t=this.querySelector(".queued.dialog.actuator"),e=this.querySelector("#queuedDialogCommand");t.addEventListener("click",r=>Ks(r,e),!0)}function Ks(t,e){const r=["One","Two","Three","Four","Five"].map(Ys);for(const s of r)e.dispatchEvent(s)}function Ys(t){const e={type:"string",content:["<header>","<h1>","Request"," - ",t,"</h1>","</header>","<div>","Body for ",t,"</div>","<footer>","<h3>Footer</h3>",`<button is="as-button" onclick="this.dispatchEvent( new MessageEvent('as:dialog:close') )">Request Close</button>`," ",'<button is="as-button" command="close" commandfor="queuedDialogCommand">Dismiss All</button>',"</footer>"].join("")};return new MessageEvent("as:dialog:request",{data:e})}const{init:Vs}=new class{init=t=>{Zs.call(t)}},Ct=Object.freeze(Object.defineProperty({__proto__:null,backdrop:Gs,conventional:Us,docs:Et,fullscreen:Ws,init:Vs,normal:js,queued:Fs,script:Qs,setuphtml:Hs,setupts:Xs},Symbol.toStringTag,{value:"Module"})),At=`\r
## Toast Dialogs\r
...
`,Rt=Object.freeze(Object.defineProperty({__proto__:null,basic:to,docs:At,setuphtml:Js,setupts:eo},Symbol.toStringTag,{value:"Module"})),Pt=`\r
## Quickview Dialogs\r
...
`,oo=Object.freeze(Object.defineProperty({__proto__:null,basic:so,docs:Pt,setuphtml:ro,setupts:no},Symbol.toStringTag,{value:"Module"})),ao=`\r
...
`,qt=Object.freeze(Object.defineProperty({__proto__:null,code:ao,docs:Dt,example:co,setuphtml:io,setupts:lo},Symbol.toStringTag,{value:"Module"})),po="/catalog/variables",uo="/catalog/icons",ho="/catalog/buttons",go="/catalog/tooltip",mo="/catalog/popover",fo="/catalog/dialogs",bo="/catalog/toasts",vo="/catalog/quickviews",ko="/catalog/antitamper",yo=v.interpolate($.parse(xt))(new T(de)),xo=v.interpolate($.parse(wt))(new T($s)),wo=v.interpolate($.parse($t))(new T(Ms)),$o=v.interpolate($.parse(_t))(new T(zt)),_o=v.interpolate($.parse(Tt))(new T(St)),zo=v.interpolate($.parse(Et))(new T(Ct)),To=v.interpolate($.parse(At))(new T(Rt)),Oe=v.interpolate($.parse(Pt))(new T(oo)),So=v.interpolate($.parse(Dt))(new T(qt)),Mt=[{id:po,title:"Variables",docs:yo,module:de},{id:uo,title:"Icons",docs:xo,module:{}},{id:ho,title:"Buttons",docs:wo,module:de},{id:go,title:"Tooltips",docs:$o,module:zt},{id:mo,title:"Popovers",docs:_o,module:St},{id:fo,title:"Dialogs",docs:zo,module:Ct},{id:bo,title:"Toasts",docs:To,module:Rt},{id:vo,title:"Quickviews",docs:Oe,module:Oe},{id:ko,title:"Antitamper",docs:So,module:qt}].reduce((t,e)=>t.set(e.id,e),new Map),Lt=[...Mt.values()],Ot=[...Mt.values()].map(({id:t,title:e})=>({id:t,title:e})),Eo=`\r
...
`;var qo=Object.getOwnPropertyDescriptor,Mo=(t,e,r,s)=>{for(var n=s>1?void 0:s?qo(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n};const Lo="as-catalog-docs";let Be=class extends we{get"as:state"(){return{}}render(){return`
            <style>${Do}</style>
            ${Po}
        `}};Be=Mo([k(Lo)],Be);var Oo=Object.defineProperty,Bo=Object.getOwnPropertyDescriptor,Bt=t=>{throw TypeError(t)},Io=(t,e,r)=>e in t?Oo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,No=(t,e,r,s)=>{for(var n=s>1?void 0:s?Bo(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n},Ie=(t,e,r)=>Io(t,typeof e!="symbol"?e+"":e,r),Ho=(t,e,r)=>e.has(t)||Bt("Cannot "+r),Xo=(t,e,r)=>e.has(t)?Bt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),It=(t,e,r)=>(Ho(t,e,"access private method"),r),Ne,He,U,Nt,Ht;const Xe="as:query:variables",jo=Ot.slice(0,5),Fo=Ot.slice(5),Qo={dialogs:"Queued Modal",toasts:"Toasts",quickviews:"Quickviews",antitamper:"Antitamper"},Go="at-catalog";let je=class extends(He=W,Ne=Xe,He){constructor(){super(...arguments),Xo(this,U),Ie(this,"as:crawler",new Lr(this)),Ie(this,Ne,document.createElement("input"))}get"as:state"(){const{id:t}=this;return{id:t,menu:new J(jo).with('<li class="menu item"><a class="item control" href="#${id}">${title}</a></li>'),more:new J(Fo).with(Co).use(Qo,"titles"),documentation:new J(Lt).with(Eo)}}"change:menu:item"(t){const{target:e}=t,{id:r}=e;this.querySelector(`.content.section .section.control[id="${r}"] + .section.document`).scrollIntoView({behavior:"smooth"})}"as:update:handler"(t){const{[Xe]:e}=this;e.checked=!0}connectedCallback(t=super.connectedCallback()){It(this,U,Nt).call(this),this.addEventListener("change",this,!0)}disconnectedCallback(t=super.disconnectedCallback()){this.removeEventListener("change",this,!0)}render(){return`
            ${super.render()}
            <style>${Ro}</style>
            ${Ao}
        `}};U=new WeakSet;Nt=function(){for(const t of Lt)It(this,U,Ht).call(this,t)};Ht=function(t){if(!t?.module?.init)return;const{module:e}=t;e.init(this)};je=No([k(Go)],je);var Wo=Object.defineProperty,Uo=Object.getOwnPropertyDescriptor,Zo=(t,e,r)=>e in t?Wo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r,Ko=(t,e,r,s)=>{for(var n=s>1?void 0:s?Uo(e,r):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(n=a(n)||n);return n},Yo=(t,e,r)=>Zo(t,e+"",r);const{log:Fe}=console,Vo="as-app";let ue=class extends we{get"as:state"(){return{hero:"",speed:"quick",animal:"dog"}}"attr:test"(t){Fe("@app.attr.test",t)}connectedCallback(t=super.connectedCallback()){Fe("CONNECTED!...")}createRenderRoot(){return this}render(){return`
            <style>${Qn}</style>
            ${Fn}
        `}};Yo(ue,"observedAttributes",["test"]);ue=Ko([k(Vo)],ue);const{log:Jo}=console,Xt=document.querySelector("as-app");setTimeout(t=>Xt.setAttribute("test","aaaaaaaaaaaaa"),1e3*3);Jo(">...",Xt);
