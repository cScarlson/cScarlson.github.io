...
if (!has) customElements.define(TAGNAME, class SlashMagCloudflareTest extends HTMLElement {
    ...
    connectedCallback() {
        ...
        // this.innerHTML = `<iframe src="https://magazinejs.otocarlson.workers.dev/magazinejs/content/article.rmd.html" is="as-frameless-x"></iframe>`;
        console.log(`@REMOTE#CustomElement#Experiment.connectedCallback`, this);
    }
