...
### Structure
<img src="./figures/diagrams/the.cdc.pattern.structure.0.png" />
...
- **Modifier**: Optional class(es) that modifies the appearance or behavior of the element.
