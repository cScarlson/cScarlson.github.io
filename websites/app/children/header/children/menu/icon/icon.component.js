...
$('csc-menu-icon', class extends CustomElement {
    ...
    constructor() {
        super({ templateURL: '/websites/app/children/header/children/menu/icon/icon.component.html', styleURL: '/websites/app/children/header/children/menu/icon/icon.component.css' });
