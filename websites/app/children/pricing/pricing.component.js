...
$('csc-pricing', class extends CustomElement {
    ...
    constructor() {
        super({ templateURL: '/websites/app/children/pricing/pricing.component.html', styleURL: '/websites/app/children/pricing/pricing.component.css' });
    }
    
    async connectedCallback() {
        const response = await fetch('/websites/app/children/pricing/pricing.template.html');
