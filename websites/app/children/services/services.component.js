...
$('csc-services', class extends CustomElement {
    ...
    constructor() {
        super({ templateURL: '/websites/app/children/services/services.component.html', styleURL: '/websites/app/children/services/services.component.css' });
    }
    
    async connectedCallback() {
        const response = await fetch('/websites/app/children/services/service.template.html');
